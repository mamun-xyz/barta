...
@section('content')
 <main class="container max-w-2xl mx-auto space-y-8 mt-8 px-2 min-h-screen">
      ...
      <section
        ...
        <div
         ...
         <div class="relative">
          ...
          <!-- User Meta -->
          <div>
            <h1 class="font-bold md:text-2xl">{{($user_info[0]->firstname ." ".  $user_info[0]->lastname)}} </h1>
            <p class="text-gray-700">{{($user_info[0]->bio)}}</p>
          </div>
          <!-- / User Meta -->
        </div>
        <!-- /Profile Info -->
        ...
        @if ( $logged_in_user_uuid == $user_info[0]->user_uuid )
        <a
          href="{{url('profile/edit/'.$user_info[0]->user_uuid)}}"
          type="button"
      ...
      <form action="{{url('/post/store/'.$logged_in_user_uuid)}}"    
        method="POST"
      ...
      <div>
        <div class="flex items-start space-x-3">
            ...
            <div class="text-gray-700 font-normal w-full">
                <textarea class="block w-full pt-2 text-gray-900 rounded-lg border-none outline-none focus:ring-0 focus:ring-offset-0" name="barta" rows="2" placeholder="What's going on {{($user_info[0]->firstname)}}?"></textarea>
            </div>
        </div>
    </div>
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center space-x-3">
              ...
              <div class="text-gray-900 flex flex-col min-w-0 flex-1">
                <a
                  href="{{url('/profile/'.$user_info->user_uuid)}}"
                ...
                <div class="flex items-center">
                      <span>@</span>
                      <a href="{{url('/profile/'.$user_info->user_uuid)}}" class="hover:underline text-sm text-gray-500 line-clamp-1">
                        {{$user_info->user_name }}   
                      </a>
                </div>
                @endif
